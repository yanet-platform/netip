...
pub use net::{
    ...
    Ipv6RangeNetworks, ipv4_aggregate, ipv4_binary_split, ipv4_range_to_networks, ipv6_aggregate,
    ipv6_bicontiguous_find_containment, ipv6_binary_split, ipv6_range_to_networks,
};
